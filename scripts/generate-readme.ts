...
function generateReadme(user: GitHubUser, repos: Repo[], posts: BlogPost[]): string {
  ...
  return [
    ...
    '## 🎯 What I Do',
    '',
    `${user.bio ?? 'Agentic QA Engineer with 5+ years building test automation. Author of the open-source Agentic QA Boilerplate — KATA + Playwright, a create-agentic-qa scaffolder, 20+ agent skills, a full Xray CLI, and 7 MCP integrations.'}`,
    '',
