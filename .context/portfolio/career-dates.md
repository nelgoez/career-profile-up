...
|------|---------|-------|-----|----------|
| Full Stack Web Developer | Henry Bootcamp | Apr 2021 | Jun 2021 | 3 mos |
...
- `nelthor.qzz.io/components/timeline.tsx` — Experience section periods
- `nelthor.qzz.io/app/cv/page.tsx` + `app/cv/es/page.tsx` — printable CV
- `nelthor.qzz.io/messages/en.json` + `es.json` — hero bio + brands description
- `nelthor.qzz.io/app/layout.tsx` — SEO metadata description
- `nelthor.qzz.io/app/behind-the-scenes/page.tsx` — era headers (Traditional vs Agentic)
- `nelthor.qzz.io/public/architecture.svg` — column captions
- `nelthor.qzz.io/content/blog/sdet-to-agentic-qa.mdx` — career timeline + section heading
- `README.md` — tagline
- `.context/portfolio/linkedin-strategy.md` + `linkedin-about-copy.md` + `linkedin-experience-draft.md` — LinkedIn drafts
