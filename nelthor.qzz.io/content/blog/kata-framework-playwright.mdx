...
After building automation at scale for 5+ years, the pattern that consistently works is the **KATA (Component Action Test Architecture)** framework: a three-layer architecture designed for both human and AI collaboration.
...
The full KATA implementation is in **[bunkai-qa-engineering](https://github.com/nelgoez/bunkai-qa-engineering)** — my open-source Agentic QA Boilerplate. More details in an upcoming deep-dive.
